...
public class NotationQueueTest {
	...
	public double num=0.0, num1=1.0, num2=2.0, num3=3.0, num4=4.0, num5=5.0;
	public ArrayList<Double> filled=new ArrayList<Double>();
	@Before
	...
	public void testDequeueStudent() {
		...
		try {
			assertEquals(0.0, doubleQ.dequeue(),0.01);
			assertEquals(1.0, doubleQ.dequeue(),0.01);
			assertEquals(2.0, doubleQ.dequeue(),0.01);
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleQ.dequeue();
			assertTrue("This should have caused an QueueUnderflowException", false);
		}
